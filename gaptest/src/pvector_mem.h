...
*/
//quick modification to support mem specific spot
...
class pvectormem {
 public:
  ...
  pvectormem() : start_(nullptr), end_size_(nullptr), end_capacity_(nullptr) {}

  explicit pvectormem(size_t num_elements, void *mem_pointer) {
    start_ = (float*)mem_pointer;
    end_size_ = start_ + num_elements;
    end_capacity_ = end_size_;
  }

  pvectormem(size_t num_elements, void *mem_pointer, T_ init_val) : pvectormem(num_elements, mem_pointer) {
    fill(init_val);
  }
  
  pvectormem(iterator copy_begin, iterator copy_end)
      : pvectormem(copy_end - copy_begin) {
  ...
  pvectormem(const pvectormem &other) = delete;

  // prefer move because too much data to copy
  pvectormem(pvectormem &&other)
  ...
  pvectormem& operator= (pvectormem &&other) {
    start_ = other.start_;
